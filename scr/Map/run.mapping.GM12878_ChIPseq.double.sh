#!/bin/bash
#PBS -N GM12878_SA2KOA13_SA2201_ChIPseq_SA2Clone61Ab_20230322_B1S2
#PBS -l nodes=node03:ppn=15
...
EXTENSION=250
#####################################################################
PREFIX=GM12878_SA2KOA13_SA2201_ChIPseq_SA2Clone61Ab_20230322_B1S2
PREFIX_SAMPLE_1=GM12878_SA2KOA13_SA2201_ChIPseq_SA2Clone61Ab_20230322_B1
PREFIX_SAMPLE_2=GM12878_SA2KOA13_SA2201_ChIPseq_SA2Clone61Ab_20230322_B1S2

#####################################################################
inputdir=/public2/TangLabData/CleanData/ChIP-seq
Fastq1_1=${inputdir}/${PREFIX_SAMPLE_1}/${PREFIX_SAMPLE_1}_R1.fq.gz
Fastq1_2=${inputdir}/${PREFIX_SAMPLE_1}/${PREFIX_SAMPLE_1}_R2.fq.gz

Fastq2_1=${inputdir}/${PREFIX_SAMPLE_2}/${PREFIX_SAMPLE_2}_R1.fq.gz
Fastq2_2=${inputdir}/${PREFIX_SAMPLE_2}/${PREFIX_SAMPLE_2}_R2.fq.gz
### merge fq
zcat ${Fastq1_1} ${Fastq2_1} > ${PREFIX}_R1.fq
zcat ${Fastq1_2} ${Fastq2_2} > ${PREFIX}_R2.fq
gzip ${PREFIX}_R1.fq
gzip ${PREFIX}_R2.fq
### set input
Fastq_R1=${PREFIX}_R1.fq.gz
Fastq_R2=${PREFIX}_R2.fq.gz
#####################################################################
## mapping
